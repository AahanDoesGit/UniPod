...
Home screen: Music / Playlists / Settings / About

Wheel routing:
  TOP    → scroll up   (on home screen: no-op when already at top)
  BOTTOM → scroll down
  CENTER → open selected item
  RIGHT  → open selected item
  LEFT   → no-op (already home), flash only
  MENU   → go_home() — already here
"""
