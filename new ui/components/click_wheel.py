...
Draws the classic iPod-style circular click wheel.
Handles zone hit detection and press feedback animation.
"""
...
class ClickWheel:
    ...
    def set_center_down(self, down: bool):
        if self._center_down != down:
            ...
            self._base_surf   = None    # force redraw
    ...
    def _draw_zone_flash(self, surface: pygame.Surface):
        """Draw translucent pressed-zone sector."""
    ...
    def draw(self, surface: pygame.Surface) -> pygame.Rect:
        """Draw wheel and shell band. Returns dirty rect."""
        # Thin divider band between screen and shell
        pygame.draw.rect(surface, SHELL_DARK,
                         (0, DIVIDER_BAND_Y, SCREEN_W, DIVIDER_BAND_H))

        # Build and blit base wheel
